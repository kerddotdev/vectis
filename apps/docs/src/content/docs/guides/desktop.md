...
- Connections opens GitHub account linking and machine pairing in your browser. Pairing requires the configured Keychain helper and a running local service. Compare the verification code before approval, then finish pairing in Vectis. Refresh repositories to verify which connected repositories target this machine.
