...
3. Prepare the `ubuntu` environment. Prepare the `macos-26-arm64` environment, and while its setup console is open, install Xcode 26 and accept its license in the guest before finishing setup.
